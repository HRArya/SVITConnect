...
function TweetPage(props) {
      ...
      buttons: [
        {
          ...
          onClick: () => {
            axios
              .get(BEUrl + "/delete_tweet/" + tweet_page_id)
              .then((res) => {
                toast("Deleted", {
      ...
      buttons: [
        {
          ...
          onClick: () => {
            axios
              .get(BEUrl + "/delete_comment/" + comment_id)
              .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(BEUrl + `/full_tweet/${tweet_page_id}`)
      .then((data) => {
